...
public:
  ...
  void
  createOrder(string pOrderName,
              Order *pOrder); // the name should ideally not be passed
                              // id should be generated. using name as id here

  Order *
  getOrder(string pOrderId); // this id should be returned while creating order
